			...
			frappe.call({
				...
				callback: function (r) {
					if (r && r.message) {
						...
						frm.set_value("service_terms", r.message.service_terms);
						frm.set_value("bank_details", r.message.bank_details);
						...
						if (frm.doc.requires_fulfilment) {
							...
							r.message.contract_template.fulfilment_terms.forEach((element) => {
								...
								d.custom_content_and_method = element.custom_content_and_method;
								d.notes = element.notes;
							});
